...
function acstheme_supports () {
    ...
    add_theme_support('post-thumbnails'); /**ity mi affihcer ny image en avant kely */
    add_theme_support('menus');
    register_nav_menu('header', 'En tête du menu');
    register_nav_menu('footer', 'Pied de page');

    add_image_size( 'post-thumbnail', 350, 215, true); /**ity ny habean'ny sary aminy article */
